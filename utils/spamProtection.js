...
module.exports = async function spamProtection(message, client) {
    ...
    if (!spamTriggered) {
        ...
        imageScamTimers.set(userId, setTimeout(async () => {
            ...
            await sendModLog(client, {
                ...
                title: "<:relic_icon:1526924375847211090> Possible image scam detected",
    ...
    try {
        ...
        await sendModLog(client, {
            title: "<:setting:1526924377206161579> Possible compromised account detected",
            color: 0xff0000,
            user: message.author,
            channel: message.channel,
            reason: reasons,
